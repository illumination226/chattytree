Chattytree::Application.routes.draw do
  ...
  get "groupon/abilene"
  get "groupon/akron-canton"
  get "groupon/albany-capital-region"
  get "groupon/albuquerque"
  get "groupon/allentown-reading"
  get "groupon/amarillo"
  get "groupon/anchorage"
  get "groupon/ann-arbor"
  get "groupon/appleton"
  get "groupon/asheville"
  get "groupon/athens-ga"
  get "groupon/atlanta"
  get "groupon/augusta"
  get "groupon/austin"
  get "groupon/chicago"
  get "groupon/los-angeles"  
  get "groupon/phoenix"
  get "groupon/miami"
